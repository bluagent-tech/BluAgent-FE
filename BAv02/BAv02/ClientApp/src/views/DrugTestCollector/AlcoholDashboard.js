...
import { Col, Row, CardBody, Card, FormGroup, Badge } from "reactstrap";
import styled from "styled-components";
import DataTable from "react-data-table-component";
import dateConvert from "../../services/dateConvertTables";
import DropdownMenu from "../../components/DropdownMenu";
import FileUpload from "../../containers/DrugTestCollector/FileUploadAlcoholTestCollector";
import { bindActionCreators } from "redux";
import { connect } from "react-redux";
import { actionCreators } from "../../store/DrugAndAlcoholTesting";

import AlcoholHead from "./AlcoholHead";
        ...
        <DropdownMenu
          ...
          menuOptions={[
            [
              "Details",
              () => {
                window.location.replace("/#/AlcoholTestDetails/" + schedule.Id);
              },
            ],
          ]}
        />
      ...
      <div className="text-center">
        <DropdownMenu
          ...
          menuOptions={[
            ...
            [
              "Add Alcohol Test Results",
              () => {
                reduxProps.openCloseAlcoholTest(schedule.Id);
              },
            ],
          ]}
        />
...
class AlcoholDashboard extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.props.getProviderScheduledAlcoholTests(provider);
  }
  ...
  render() {
    ...
    const donors = this.mapDonorsForDataTable(this.props.providerAlcoholTests);
        ...
        <div className="container-fluid" style={{ marginTop: "3%" }}>
          <div className="animated fadeIn">
            <Row>
              <Col sm="12">
                <AlcoholHead
                  providerDrugTest={this.props.providerAlcoholTests}
                />
              </Col>
            </Row>
            <Row>
