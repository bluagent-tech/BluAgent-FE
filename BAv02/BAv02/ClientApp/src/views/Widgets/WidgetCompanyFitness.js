...
class WidgetCompanyFitness extends Component {
  render() {
    const {
      className,
      cssModule,
...
WidgetCompanyFitness.propTypes = propTypes;
WidgetCompanyFitness.defaultProps = defaultProps;

export default WidgetCompanyFitness;
