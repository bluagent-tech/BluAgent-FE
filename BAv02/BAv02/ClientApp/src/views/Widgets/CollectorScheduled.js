...
class CollectorScheduled extends Component {
  render() {
    const {
      className,
      cssModule,
...
CollectorScheduled.propTypes = propTypes;
CollectorScheduled.defaultProps = defaultProps;

export default CollectorScheduled;
