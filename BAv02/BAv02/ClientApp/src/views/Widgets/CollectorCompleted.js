...
class CollectorCompleted extends Component {
  render() {
    const {
      className,
      cssModule,
...
CollectorCompleted.propTypes = propTypes;
CollectorCompleted.defaultProps = defaultProps;

export default CollectorCompleted;
