...
class TrailersNotifications extends Component {
  render() {
    const {
      className,
      cssModule,
...
TrailersNotifications.propTypes = propTypes;
TrailersNotifications.defaultProps = defaultProps;

export default TrailersNotifications;
