...
const ComplianceTruck = () => {
  ...
  const [truck] = useState(JSON.parse(localStorage.getItem("trucksReport")));
    ...
    <div className="card">
      <div className="">
        <div className="col-sm-12">
          <h4 className="text-muted mt-4">Trucks Fitness</h4>
          ...
          <div className="col mt-4">
            <div className="col-sm-12">
              <p className="text-muted">
                <strong>{truck.ActiveTrucks} Active Trucks</strong>
              </p>
            </div>
...
export default ComplianceTruck;
