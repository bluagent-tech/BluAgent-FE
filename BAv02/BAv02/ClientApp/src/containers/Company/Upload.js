  ...
  render() {
    ...
    return (
      <div className='col-md-3'>
        <Modal isOpen={this.props.modalDocsUpload} className={'modal-lg '}>
          <ModalHeader name='modalDocsUpload' toggle={this.onClose}>
            UPLOAD FILES
          </ModalHeader>
              ...
              <FormGroup row>
                <Col md='12'>
                  ...
                  <TableCom
                    rowItems={rowItems}
                    header={rep}
                    count={this.props.countD}
                    page={this.props.pageD}
                    getItems={(index) => {
                      this.props.getAllDocuments(
                        JSON.parse(localStorage.getItem('user')).Id,
                        index,
