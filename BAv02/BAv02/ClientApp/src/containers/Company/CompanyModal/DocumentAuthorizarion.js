...
import NoAgremmentResponse from "./NoAgremmentResponse";
import { usePDF } from "@react-pdf/renderer";
import DriverAgreement from "../../../components/pdf/DriverAgreement";
import Loading from "../../../components/Loading";
import { Collapse } from "react-collapse";
import Switch from "react-switch";
import { StyleSheet } from "@react-pdf/renderer";

const DocumentAuthorizarion = (props) => {
    ...
    <div>
      {props.driver.FileSignature !== null ? (
        <div>
          ...
          <h6>AUTHORIZATION</h6>
          <Modal isOpen={toggleAA} className={"modal-lg"} backdrop={"static"}>
            ...
            <ModalBody>
              <div style={style.page}>
                <div style={style.section}>
                  ...
                  >
                    {isSpanish ? (
                      <div style={style.titleTop} className="px-5 text-center">
                  ...
                  {isSpanish ? (
                    <div>
                      ...
                      <Collapse isOpened={collapse}>
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            inquiries and releasing information in connection
                            with my application.
                          </div>
                        </div>
                        <div style={style.section}>
                        ...
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            employers;
                            <br></br>• Have errors in the information corrected
                            by previous employers and for those previous
                            employers to re-send the corrected information to
                            the prospective employer; and
                            <br></br>• Have a rebuttal statement attached to the
                            alleged erroneous information, if the previous
                            employer(s) and I cannot agree on the accuracy of
                            the information.”
                          </div>
                        </div>
                      </Collapse>
                      ...
                      >
                        <h4 style={style.titleAgreement} className="mb-0 mr-1">
                          {" "}
                          Pre-employment Urinalysis and Breath Analysis Consent
                          Form
                        </h4>
                      </div>
                      <Collapse isOpened={collapse2}>
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            driver-applicants of this employer must be tested
                            for controlled substances and alcohol as a
                            pre-condition for employment.
                            <br></br>I consent to the urine sample collection
                            and testing for controlled substances, and the
                            breath sample collection and testing for alcohol.
                            ...
                            of my controlled substance test. Negative and
                            positive results will be reported to the employer.
                            If the results are positive, the controlled
                            substance will be identified.
                            <br></br>
                            Alcohol test results will be maintained by the
                            employer.
                            <br></br>
                            The results will not be released to any other
                            parties without my written authorization.
                          </div>
                        </div>
                      </Collapse>
                      <br></br>
                      ...
                      <Collapse isOpened={collapse3}>
                        <div style={style.section}>
                          <div style={style.textContent}>
                            THE BELOW DISCLOSURE AND AUTHORIZATION LANGUAGE IS
                        ...
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            cannot change or correct this data. Your request
                            will be forwarded by the DataQs system to the
                        ...
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            Pre-Employment Screening Program (PSP) system to
                            seek information regarding my commercial driving
                            safety record and information regarding my safety
                            inspection history. I understand that I am
                            authorizing the release of safety performance
                            information including crash data from the previous
                            five (5) years and inspection history from the
                            previous three (3) years. I understand and
                            acknowledge that this release of information may
                            assist the Prospective Employer to make a
                            ...
                            to be incorrect. I understand I may challenge the
                            accuracy of the data by submitting a request to
                            https://dataqs.fmcsa.dot.gov. If I challenge crash
                            or inspection information reported by a State, FMCSA
                            cannot change or correct this data. I understand my
                            request will be forwarded by the DataQs system to
                            the appropriate State for adjudication. I understand
                            that any crash or inspection in which I was involved
                            will display on my PSP report. Since the PSP report
                            does not report, or assign, or imply fault, I
                            acknowledge it will include all CMV crashes where I
                            was a driver or co-driver and where those crashes
                            were reported to FMCSA, regardless of fault.
                            Similarly, I understand all inspections, with or
                            without violations, will appear on my PSP report,
                            and State citations associated with FMCSR violations
                            that have been adjudicated by a court of law will
                        ...
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            Disclosure and Authorization, Prospective Employer
                            may obtain a report of my crash and inspection
                            history. I hereby authorize Prospective Employer and
                            its employees, authorized agents, and/or affiliates
                            to obtain the information authorized above.
                          </div>
                        </div>
                      </Collapse>
                      <br></br>
                      ...
                      <Collapse isOpened={collapse4}>
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            Vehicles(DMV) to disclose or other make available,
                            my driving record, to my employer,{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            .
                            ...
                            Employer Pull Notice(EPN) program to receive a
                            driver record report at least once every 12 months
                            or when any subsequent, failure to appear, accident,
                            driver's license suspension, revocation or any other
                            action is taken against my driving privilege during
                            employment.
                            <br />
                      ...
                      <Collapse isOpened={collapse5}>
                        <div style={style.section}>
                          <div style={style.textContent}>
                            THE UNDERSIGNED DOES HEREBY ACKNOWLEDGE AND CERTIFY
                            AS FOLLOWS:
                            <br></br>
                            1. Certifies that the undersigned is an employee, or
                            has applied to become an employee of the below named
                            employer in a position which involves the operation
                            of a motor vehicle and the undersigned gives his or
                            her consent to the release of their driving record
                            (MVR) for review by:{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            .<br></br>
                            2. That the undersigned authorizes his or her
                            driving record to be periodically obtained and
                            reviewed for the purpose of initial and continued
                            employment.
                            <br></br>
                            3. That all information presented in this form is
                            true and correct. The undersigned makes this
                            certification and affirmation under penalty of
                            perjury and understands that knowingly making a
                            false statement or representation on this form is a
                            criminal violation.
                          </div>
                        </div>
                      </Collapse>
                      ...
                      <Collapse isOpened={collapse6}>
                        ...
                        <div style={style.section}>
                          <div style={style.textContent}>
                            ...
                            , hereby provide consent to conduct a multiple
                            limited queries for the duration of employment of
                            the FMCSA commercial Driver's License Drug and
                            Alcohol ClearingHouse to determine wheter drug or
                            alcohol violation information about me in the
                            ClearingHouse. I understand that if the limited
                            query conducted by{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                      ...
                      <Collapse isOpened={collapse7}>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            Esta póliza cubre a los solicitantes que han
                            cumplido con las normas señaladas en el Apéndice A,
                            incluyendo a los solicitantes de puestos temporales,
                            estacionales, tiempo parcial o bien que trabajan
                            menos de medio tiempo o tiempo limitado, y a todos
                            aquellos que no están en un empleo permanente. La
                            lista principal de las posiciones reales para
                            pre-empleo droga se mantendrá en el Departamento de
                            Servicios para los empleados. Esta política no se
                            aplica a los empleados actuales que son candidatos
                            internos para las posiciones abiertas.
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            plantear graves riesgos para el usuario y sus
                            colegas, así como para el público que utilicé el
                            servicio. Por lo tanto, "COMPANYNAME" ha elegido
                            llevar a cabo la prueba de pre-empleo para evitar la
                            contratación de personas cuyo uso no autorizado de
                            drogas crea un potencial de deterioro o inseguridad
                            en el rendimiento del trabajo.
                            <br></br>
                            Los solicitantes de puestos de trabajo que cumplen
                            con las normas señaladas en el Apéndice A se
                            someterá a la detección de la presencia de drogas
                            ilegales, como condición para el empleo. Los
                            solicitantes estarán obligados a someterse a un
                            análisis de orina en un laboratorio de "COMPANYNAME"
                            de su elección.
                            <br></br>
                            <br></br>
                            ...
                            <ul>
                              ...
                              <li>
                                Mantenimiento de Registros de resultados...
                              </li>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            prueba de drogas que se verifique como positivo,
                            para el uso no autorizado de sustancias controladas,
                            ...
                            para proporcionar una muestra válida. El resultado
                            de la segunda prueba determinará si el solicitante
                            es candidato para el empleo.
                            <br></br>
                            Una persona que recibe cualquiera de los siguientes
                            resultados en la prueba de droga no es candidata
                            para ser contratada, y será descalificado por
                            "COMPANYNAME" por un período de veinticuatro (24)
                            meses a partir de la fecha del resultado de la
                            prueba:
                            <br></br>
                            <ul>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            La marihuana es una sustancia controlada Clase I, y
                            su uso es ilegal bajo la ley federal. Aunque La ley
                            de California (§ 11362.5 (b) (1) (A) y (d) de 1996
                            ()) exime de persecución penal en corte del estado a
                            las personas que obtengan una "tarjeta de
                            identificación en el registro" del Departamento de
                            California de Servicios Humanos, sobre la base de
                            una declaración de su asistente médico, que el
                            individuo tiene una "condición médica debilitante",
                            esto no es una explicación aceptable para una prueba
                            positiva de la droga en esta Política.
                            <br></br>
                        ...
                        <div style={style.section}>
                          <div style={style.section}>
                            <strong>
                              Procedimientos de prueba de la droga
                            </strong>
                          </div>
                          <div style={style.textContent}>
                            La muestras de orina para la prueba de drogas será
                            realizado por personal calificado utilizando la
                            cadena de custodia procedimientos que se describen
                            en los Estados Unidos del Departamento de Transporte
                            (DOT) regulaciones (49 CFR Parte 40) y con el
                            respeto a la privacidad y la dignidad de la persona
                            que otorgara la muestra.
                            <br></br>
                            En la muestra de prueba de la droga se reunirá por
                            lo menos 45 ml de orina. Si el solicitante es
                            incapaz de proporcionar un volumen suficiente de
                            orina en el primer intento ("vejiga tímida"), él /
                            ella tendrá la oportunidad de tomar hasta 40 onzas
                            de fluidos dentro de tres horas. Al final de este
                            período, si una muestra de volumen adecuado ha no ha
                            sido siempre, la prueba será cancelada. Una nueva
                            prueba se permitirá si el solicitante proporciona
                            una evaluación médica de un médico con licencia,
                            aceptable para el{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            ...
                            solicitante deberá iniciar una segunda observación
                            en la colección. Si la segunda muestra también está
                            fuera del rango aceptable, el solicitante será
                            descalificado. Si dentro del rango, la segunda
                            muestra se pondrá a prueba en el laboratorio. Sólo
                            los laboratorios certificados por el Abuso de
                            Sustancias y Servicios de Salud Mental. Cuando una
                            prueba de detección inicial de drogas es positivo,
                            una segunda prueba de confirmación automáticamente
                            se llevará a cabo. La confirmación de las pruebas
                            positivas será reportada por el laboratorio; para el
                            MRO para su verificación (véase "Prueba de la Droga
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            certificado no identifican automáticamente al
                            empleado o solicitante por ser una violación de esta
                            política. El MRO lleva detallado conocimiento de las
                            posibles explicaciones alternativas médicas para su
                            / su revisión de la prueba resultados. Esta revisión
                            es realizada por la MRO antes de la transmisión de
                            los resultados de{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                        ...
                        <div style={style.section}>
                          <div style={style.section}>
                            <strong>
                              Evaluación médica Opciones Oficiales de
                              Información:
                            </strong>
                          </div>
                          <div style={style.textContent}>
                            <ul>
                              ...
                              <li>
                                ...
                                (con defecto establecido) o no corregida Un
                                error. "Una prueba de drogas se cancela ni
                                positivo ni negativo y no consecuencias son que
                                se le atribuye. El solicitante tendrá la
                                oportunidad de tomar una segunda prueba.
                              </li>
                              <li>
                                "Cancelado - Resultado no válido." Un "número no
                                válido" significa que el laboratorio no pudo
                                para obtener un resultado válido cuando se trata
                                de examinar la muestra. Si el MRO ha aceptó la
                                explicación de los donantes en cuanto a por qué
                                el laboratorio no pudo obtener un resultado
                                válido, el MRO notificará al condado y una nueva
                                prueba será permitido. Si el MRO no ha aceptado
                                la explicación de los donantes, el MRO
                                notificará "COMPANYNAME" y el solicitante será
                                descalificado.
                              </li>
                              <li>
                                "positiva o positiva Diluir" - El solicitante
                                será descalificado.
                              </li>
                              <li>
                                "adulterado" - El solicitante será
                                descalificado.
                              </li>
                              <li>
                                "sustituido" - El solicitante será
                                descalificado. MRO verifica sin notificar a los
                                empleados.
                              </li>
                            </ul>
                            El MRO está autorizado para comprobar como positiva
                            una prueba o bien negativa. "COMPANYNAME" ha
                            realizado con éxito y documentado un contacto con el
                            ...
                            graves, lesiones u otras circunstancias caso de
                            fuerza mayor que él / ella en contacto con el MRO.
                            Sobre la base de esta información, el MRO puede
                            volver a abrir la verificación, lo que permite que
                            el donante presente una información relativa a una
                            explicación legítima para la prueba positiva. Si el
                            MRO concluye que no existe una explicación legítima,
                            el MRO deberá verificar la prueba como negativo.
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            designado Representante (DER). La confidencialidad
                            se mantiene estrictamente. Si el resultado es
                            positivo, el MRO o su / su representante autorizado
                            dará informe de la identidad de la sustancia
                            controlada.
                            <br></br>
                            Los solicitantes pueden obtener copias de los
                            resultados de la prueba mediante la solicitud de las
                            mismas por escrito de la MRO dentro de los 60 días
                            de ser notificado de los resultados.
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            pruebas de drogas en un sistema de archivo seguro
                            con información disponible sólo en una "necesidad de
                            saber" por un período de dos años.
                            <br></br>
                            <strong>Definición de Términos</strong>
                            <br></br>
                            <strong>Muestras adulteradas:</strong> Una muestra
                            que contiene una sustancia que no se espera que este
                            ...
                            <br></br>
                            <strong>CFR:</strong> Código de los Estados Unidos
                            de Regulaciones Federales.
                            <br></br>
                            <strong>Cadena de custodia:</strong> Procedimiento
                            para tener en cuenta la integridad de cada muestra
                            de orina por el seguimiento de su manejo y
                            almacenamiento desde el punto de recogida de hasta
                            la disposición final de la muestra. Estos
                            procedimientos se requieren que un minucioso
                            análisis de drogas apropiadas que forman parte de un
                            Departamento de Salud y Servicios Humanos (DHHS), y
                            Abuso de Sustancias, Servicios de Salud Mental
                            (SAMHSA) laboratorio certificado se utiliza en de la
                            colección a la recepción por el laboratorio.
                            <br></br>
                            ...
                            ayuda a los solicitantes y/o empleados, recogiendo
                            la muestra de orina para el proceso.
                            <br></br>
                            <strong>Prueba de confirmación:</strong> Un segundo
                            método de análisis de pruebas de drogas para
                            identificar la presencia de una droga independiente
                            de la prueba inicial y se utiliza un técnica
                            diferente y principio químico de la de la prueba
                            inicial con el fin de garantizar confiabilidad y
                            precisión. Cromatografía de gases / espectrometría
                            de masas (GC-MS) es la única confirmación autorizada
                            método para la prueba de drogas del DOT mandato.
                            <br></br>
                            <strong>Sustancias Controladas:</strong> Las
                            sustancias que figuran en los Anexos I a V de 21 USC
                            802 ya que podrá ser revisado de vez en cuando (21
                            CFR 1308). Las sustancias controladas incluyen las
                            drogas ilícitas y medicamentos que pueden ser
                            autorizadas para su uso por un médico o dentista
                            para ciertos usos médicos, pero que están sujetos a
                            mal uso o abuso.
                            <br></br>
                            ...
                            resultados de las pruebas y otras comunicaciones
                            para el empleador y comunica los resultados de la
                            prueba a los distintos departamentos.
                            <br></br>
                            <strong>Diluir muestras:</strong> Una muestra con
                            valores de creatinina y la gravedad específica que
                            son más bajos lo que se esperaba de la orina humana.
                            <br></br>
                            ...
                            <br></br>
                            <strong>
                              Médico Oficial de Revisión (MRO):
                            </strong>{" "}
                            Un médico licenciado en medicina u osteopatía con
                            conocimiento de los trastornos de abuso de drogas y
                            las pruebas de drogas que es responsable de revisar
                            y la verificación de los resultados de análisis de
                            drogas antes de su comunicación a los designados,
                            Representante del empleador.
                            <br></br>
                            <strong>
                              Prueba de las Drogas negativas:
                            </strong>{" "}
                            ...
                            de los niveles establecidos, o bien que una prueba
                            de lo cual se verifica como negativa por el MRO
                            (ejemplo, la revisión mostró un resultado positivo
                            se debió a los medicamentos de prescripción o
                            cualquier otro uso autorizado de sustancias
                            controladas).
                            <br></br>
                            <strong>Prueba de Drogas Positiva:</strong>{" "}
                            Resultado de la prueba de orina que indica la
                            presencia de sustancias controladas más allá de los
                            niveles de corte.
                            <br></br>
                            <strong>
                            ...
                            Una prueba de drogas positiva confirmada (ver
                            arriba) después de investigación realizada por la
                            MRO, que ha determinado que no existe una
                            explicación legítima para la presencia de la
                            ...
                            Servicios de Salud Mental, una división de los
                            EE.UU. Departamento de Salud y Servicios Humanos
                            (DHHS), que es responsable de laboratorios de
                            certificación para realizar pruebas de drogas en el
                            lugar federales.
                            <br></br>
                            ...
                            valores de creatinina y la gravedad específica que
                            no son consistentes con la orina humana.
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            Los puestos que hayan probado las siguientes normas
                            se aplican para evaluar si un puesto de trabajo y /
                            o clasificación puede ser aprobado para pre-empleo
                            droga que prueba posterior a la oferta. Adiciones o
                            supresiones la lista de cargos y / o clasificaciones
                            elegibles para las pruebas de drogas antes del
                            empleo pueden ser hechas por solicitud del
                            supervisor del departamento afectado o la persona
                            designada para el Supervisor de Servicios de los
                            empleados. Para ser incluido en la lista, el
                            solicitante de las actividades diarias típicas que
                            incluyen los derechos de tales como:
                            <br></br>
                            Los empleados cubiertos por los Estados Unidos del
                            Departamento de Transporte Reglamentos, Código 49 de
                            Regulaciones Federales (CFR), Parte 40 y Parte 382.
                            He leído en su totalidad y entender las
                            declaraciones anteriores y las condiciones de empleo
                            Los solicitantes proporcionan la siguiente
                            información: Firma, Fecha, Licencia de conducir.
                            <br></br>
                            ...
                            está comprometido a proporcionar un lugar seguro
                            para sus empleados, y también se compromete a poner
                            a salvo, a los operadores de sus vehículos. Tenemos
                            la intención de nuestro lugar de trabajo esté libre
                            de drogas, y que los empleados estén libres de los
                            ...
                            <br></br>
                            La siguiente información es siempre de acuerdo con
                            la Parte 382.601: Patrón de contacto designado{" "}
                            <strong style={style.textDriverName}>
                              {props.company.Der}
                            </strong>{" "}
                            es la persona designada de la compañía para
                            proporcionar información sobre el programa de
                            sustancias controladas. Las preguntas deben ser
                            dirigidas a él en "Company Phone #".
                            <br></br>
                            Categorías sometidas a pruebas: Todos los
                            conductores de vehículos que tengan una licencia de
                            conductor comercial, que trabajan a tiempo parcial o
                            a tiempo completo para{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            Todos los conductores se considera que cumplen con
                            las funciones de seguridad sensible en cualquier
                            período en que se realicen efectivamente, la
                            ...
                            <ul>
                              ...
                              <li>
                                El tiempo dedicado carga o descarga de un
                                vehículo o permanecer en la preparación de
                                conducir un vehículo.
                              </li>
                              <li>
                                El tiempo dedicado supervisar o ayudar a cargar
                                o descargar un vehículo.
                              </li>
                              <li>
                                El tiempo empleado asistir a un vehículo que
                                está siendo descargada.
                              </li>
                              <li>
                              ...
                              <li>
                                El tiempo dedicado a dar una muestra de aliento
                                o de orina en el cumplimiento de las requisitos
                                de la Parte 382.
                              </li>
                            </ul>
                            <br></br>
                            ...
                            <ul>
                              ...
                              <li>
                                ...
                                que el alcohol se manifiesta y se transporte
                                como parte de un envío.
                              </li>
                              <li>
                                Ningún conductor deberá utilizar el alcohol en
                                el desempeño de las funciones de seguridad
                                sensibles.
                              </li>
                              <li>
                              ...
                              <li>
                                ...
                                prueba ocho horas siguientes al accidente, o
                                hasta que él o ella sufren un accidente después
                                de prueba de alcohol, lo que ocurra primero.
                              </li>
                              <li>
                                Ningún chofer deberá negarse a someterse a un
                                accidente de correos; al azar; razonable
                                sospecha, o de seguimiento, el alcohol o la
                              ...
                              <li>
                                ...
                                controlada es de conformidad con las
                                instrucciones de un médico y no afecta
                                negativamente la capacidad del conductor para
                                operar un vehículo comercial. (El empleador
                                puede requerir un controlador para informar al
                                patrón de uso de cualquier droga terapéutica).
                              ...
                              <li>
                                ...
                                crítica a la seguridad función, si el conductor
                                da positivo por sustancias controladas.
                              </li>
                            </ul>
                            <br></br>
                            ...
                            necesario. (Una concentración de entre 0,02 y 0,039
                            se traducirá en unas 24 horas descalificación. Una
                            ...
                            <ul>
                              ...
                              <li>
                                ...
                                siguientes al accidente, y sustancias
                                controladas, dentro de 32 horas).
                              </li>
                              <li>
                                Al azar - administrados si el nombre de un
                                conductor es seleccionado en un sorteo al azar,
                                llevan a cabo periódicamente durante todo el
                                año. Los conductores notificados de forma
                                aleatoria deben presentarse de inmediato para su
                                análisis.
                              </li>
                              <li>
                                Sospecha razonable - administrados si el
                                empleador tiene razones o sospechas para creer
                                que el conductor se encuentre en violación de
                                alguna de las prohibiciones mencionadas
                                anteriormente.
                              </li>
                              <li>
                                Volver al servicio - administrada antes de que
                                un conductor regrese al servicio, después de
                                haber salido "positivo" de sustancias
                                controladas o alcohol. También hay que
                                administrar un retorno a la prueba de servicio
                                si un conductor está inhabilitado por la prueba
                                de azar.{" "}
                              </li>
                              <li>
                            ...
                            Regulaciones Federales, Parte 40. Estos
                            procedimientos están diseñados para proteger a los
                            conductores y mantener la integridad en el proceso
                            de prueba así como garantizar la validez de los
                            ...
                            seguridad sensible. Además, el conductor estará
                            sujeto a la terminación de su / empleo con{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            . Bajo la política actual de la compañía, el
                            conductor que dé positivo se le ofrecerá “por única
                            vez” la oportunidad para ser reintegrado. Para el
                            ...
                            recomendado. Además, el conductor tendrá que
                            someterse a otra prueba.
                            <br></br>
                            <strong>La Prueba Negativa</strong>
                            <br></br>
                            Si cualquier conductor se niega a realizarse la
                            prueba bajo las condiciones establecidas en la Parte
                            382, la negativa será tratada como un resultado
                            positivo, y estará sujeto a las consecuencias de una
                            positivo de la prueba.
                            <br></br>
                            <strong>Informacion</strong>
                            <br></br>
                            Las siguientes páginas contienen información sobre
                            los síntomas y efectos del uso del alcohol y
                            sustancias controladas. Todos los empleados son
                            avisados con este documento y con los requisitos de
                            la Federal Motor Reglamento de Seguridad de
                            Autotransportes, Partes 382 y Parte 40.
                            <br></br>
                            <strong>Alcohol y Sustancias Controladas</strong>
                            <br></br>
                            Los signos generales de abuso de sustancias y
                            alcohol controlados incluyen:
                            <ul>
                              <li>La tardanza o el ausentismo</li>
                              <li>
                                Pedir prestado dinero de los compañeros de
                                trabajo
                              </li>
                            ...
                            usos médicos de THC, Efecto de la cara pálida dura
                            4.2 horas; se queda en, Sistema durante varios días
                            / semanas; Olor fuerte, como la cuerda quema
                            almacenan en las células del tejido graso, Fuerte,
                            bullicioso en las primeras etapas ahumado o por vía
                            oral, Somnolencia, etapas de euforia, aumento del
                            apetito; comportamiento desorientado, inhibiciones
                            relajado, efecto negativo en la visión periférica,
                            Una sobredosis puede causar fatiga, paranoia, no es
                            fatal.
                            <br></br>
                            <strong>
                              Utiliza los síntomas físicos y efectos
                            ...
                            <br></br>
                            Cocaína: Secreción nasal, problemas nasales Puede
                            ser utilizado como un anestésico local, Marcas de
                            agujas en los brazos muy adictivo, Mareos que duran
                            entre 1-2 horas, Pupilas dilatadas olfateó, fumado o
                            inyectado, Sequedad en la boca y la nariz mayor
                            estado de alerta, euforia, excitación, aumento del
                            pulso, y la presión arterial, insomnio, pérdida del
                            apetito, Mal aliento; sobredosis labios lamiendo
                            frecuentes pueden causar agitación, alucinaciones;
                            convulsiones, posible muerte, La falta de interés en
                            ...
                            superficial, piel fría y húmeda; convulsiones,
                            posible muerte.
                            <br></br>
                            <strong>PCP</strong>
                            <br></br>
                            Aumento del ritmo cardíaco / de la presión arterial.
                            Sofocos, sudoración, mareos, el efecto
                            entumecimiento dura varios días, Somnolencia,
                            Pupilas dilatadas, Rigidez muscular, alucinaciones,
                            Los síntomas de una sobredosis puede causar
                            intoxicación más intensa, sin olor, viajes de
                            ...
                            muy adictos, Efecto de pupilas dilatadas por más de
                            2 horas, Disminución del apetito, sequedad de boca,
                      ...
                      {signatureAgreement(props.company.Id, props.driver.Id)}
                      <br></br>
                    ...
                    <div>
                      ...
                      <Collapse isOpened={collapse7}>
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            The purposes of this policy are to provide a safe
                            and productive working environment, to prevent
                            accidents, injuries and property damage which may
                            result from drug abuse, and to protect vulnerable
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            This policy covers applicants for all positions
                            which have met the standards identified in Appendix
                            A, including applicants for temporary and seasonal
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            use may pose serious risks to the user and his or
                            her colleagues, as well as to the public we serve.
                            Therefore,
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            ...
                            employment. Applicants will be required to submit to
                            a urinalysis test at a laboratory of{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            .<br></br>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            positions which meet the standards listed in
                            Appendix A. Applicants will be notified that drug
                            testing is a requirement of the selection process. A
                            drug test result which is verified as positive for
                            unauthorized use of controlled substances, or found
                            to be substituted or adulterated, will disqualify
                            the applicant for the offered position. A negative
                            dilute result is unsatisfactory on a pre-employment
                            test. Applicants will be given one additional
                            opportunity to provide a valid specimen. The result
                            of the second test will determine whether the
                            applicant is eligible for employment.
                            <br></br>A person who receives any of the following
                            results on the drug test is not eligible to be
                            hired, and is disqualified from consideration from
                            "CompanyName" for a period of twenty-four (24)
                            months from the date of the test result:
                            <br></br>
                            <ul>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            is illegal under federal law. Although California
                            law (§ 11362.5(b) (1) (A) and (d) (1996)) exempts
                            from criminal prosecution in state court those
                            individuals who obtain a “registry identification
                            card” from the California Department of Human
                            Services, based on a statement from their attending
                            physician that the individual has a “debilitating
                            medical condition”, this is not an acceptable
                            explanation for a positive drug test under this
                            Policy.
                            <br></br>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            performed by qualified individuals in conformance
                            with current standards of practice, using chain of
                            custody procedures as described by United States
                            Department of Transportation (DOT) regulations (49
                            CFR Part 40) and with respect for the privacy and
                            dignity of the person giving the specimen.
                            <br></br>
                            ...
                            opportunity to drink up to 40 ounces of fluids
                            within three hours. At the end of this period, if a
                            sample of adequate volume has not been provided, the
                            test will be cancelled. A retest will be allowed if
                            the applicant provides a medical evaluation from a
                            licensed physician, acceptable to the{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            who has expertise in the medical issues raised by
                            the applicant's failure to provide a sufficient
                            specimen.
                            <br></br>
                            ...
                            Fahrenheit. If the specimen is outside the
                            acceptable range, the applicant will begin a second
                            unobserved collection. If the second specimen is
                            also outside the acceptable range, the applicant
                            will be disqualified. If within range, the second
                            specimen will be tested at the lab. Only
                            laboratories certified by the Substance Abuse and
                            Mental Health Services Administration (SAMHSA) of
                            the U.S. Department of Health and Human Services
                            will perform drug testing.
                            <br></br>
                            When an initial screening test for drugs is
                            positive, a second, confirmatory test will
                            automatically be performed. Confirmed positive drug
                            tests will be reported by the testing laboratory to
                            the MRO for verification (see “Drug Test Results
                            Review”).
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            the Medical Review Officer (MRO). A POSITIVE drug
                            test result is defined as the detection of any one
                            or more of the Substances listed in the table shown
                            below.
                            <br></br>
                            <br></br>
                            <table className="table">
                            ...
                            laboratory does not automatically identify an
                            employee or applicant as being in violation of this
                            policy. The MRO brings detailed knowledge of
                            possible alternate medical explanations to his/her
                            review of the test results. This review is performed
                            by the MRO prior to the transmission of results to{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                          </div>
                          ...
                          <div style={style.textContent}>
                            <ul>
                              ...
                              <li>
                                ...
                                flaw stated) or Uncorrected Flaw.” A canceled
                                drug test is neither positive nor negative and
                                no consequences are attached to it. The
                                applicant will be given the opportunity to take
                                a second test.
                              </li>
                              <li>
                                “Cancelled - Invalid Result.” An “invalid
                                result” means the laboratory was unable to
                                obtain a valid result when attempting to test
                                the specimen. If the MRO has accepted the
                                donor's explanation as to why the laboratory was
                                unable to obtain a valid result, then the MRO
                                will notify the County and a retest will be
                            ...
                            MRO is permitted to verify a test as positive, or as
                            a refusal to test because of a laboratory report of
                            a positive adulterated, or substituted specimen
                            without interviewing the applicant under the
                            ...
                            the applicant, and has asked the applicant to
                            contact the MRO, and more than 72 hours have passed
                            since{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            ...
                            <br></br>
                            <strong>NOTE:</strong> If a test is verified
                            positive under the latter circumstances, the donor
                            may give the MRO information documenting that
                            serious illness, injury, or other circumstances
                            unavoidably prevented him/her from contacting the
                            MRO. On the basis of this information, the MRO may
                            re-open the verification, allowing the donor to
                            present information concerning a legitimate
                            explanation for the positive test. If the MRO
                            concludes that there is a legitimate explanation,
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            Representative (DER). Confidentiality will be
                            strictly maintained. If the result is positive, the
                            MRO or his/her authorized representative will report
                            the identity of the controlled substance.
                            <br></br>
                            Applicants may obtain copies of their test results
                            by requesting them in writing from the MRO within 60
                            days of being notified of the results.
                          </div>
                        </div>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            DER will maintain pre-employment drug testing
                            records in a secure filing system with information
                            available only on a “need to know” basis for a
                            period of two years.
                            <br></br>
                            <br></br>
                            <strong>Definition of Terms</strong>
                            <br></br>
                            <strong>Adulterated Specimen:</strong> A specimen
                            ...
                            presence of drugs.
                            <br></br>
                            <strong>Collector:</strong> A person who instructs
                            and assists applicants and employees through the
                            ...
                            of the initial test in order to ensure reliability
                            and accuracy. Gas chromatography/mass spectrometry
                            ...
                            Controlled substances include illicit drugs and
                            drugs which may be authorized for use by a physician
                            or dentist for certain medical uses, but which are
                            ...
                            other communications for the employer and
                            communicates test results to individual departments.
                            <br></br>
                            ...
                            Transportation.
                            <br></br>
                            <strong>FHWA:</strong> Federal Highway
                            Administration.
                            <br></br>
                            <strong>FMCSA:</strong> Federal Motor Carrier Safety
                            Administration.
                            ...
                            knowledge of drug abuse disorders and drug testing
                            who is responsible for reviewing and verifying drug
                            testing results prior to their communication to the
                            Designated Employer Representative.
                            <br></br>
                            <strong>Negative Drug Test: </strong> A test in
                            which initial or confirmation testing did not show
                            evidence of a prohibited drug in an applicant's
                            system above established levels; OR, a test which is
                            verified as negative by the MRO (e.g. review showed
                            positive test was due to prescription medication or
                            other authorized use of controlled substance).
                            <br></br>
                            <strong>Positive Drug Test: </strong> A urine drug
                            test result which indicates the presence of
                            controlled Substances beyond the cut-off levels.
                            <br></br>
                            ...
                            by the SAMHSA certified laboratory which performs
                            the analyses.
                            <br></br>
                            ...
                            legitimate explanation exists for the presence of
                            the controlled substance that was detected.
                            <br></br>
                            ...
                            is responsible for certifying laboratories to
                            perform federal workplace drug testing.
                            <br></br>
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            approved for pre-employment, post-offer drug
                            testing. Additions or deletions to the list of job
                            titles and/or classifications eligible for
                            pre-employment drug testing can be made by request
                            from the affected Department Supervisor or designee
                            to the Supervisor of Employee Services. To be
                            ...
                            Regulations (CFR) Part 40 and Part 382. I have read
                            in full and understand the above statements and
                            ...
                            placing safe, professional drivers in its vehicles.
                            We intend our workplace to be drug free, and that
                            ...
                            <br></br>
                            Categories Subject to Testing: All vehicle drivers
                            who hold a Commercial Driver License, who work part
                        ...
                        <div style={style.section}>
                          ...
                          <div style={style.textContent}>
                            ...
                            <ul>
                              ...
                              <li>
                                Time spent performing driver requirements
                            ...
                            <ul>
                              <li>
                                No driver shall report for duty or remain on
                                duty while having an alcohol concentration of
                                0.02 or greater.
                              </li>
                              <li>
                                No driver shall possess alcohol, unless the
                                alcohol is manifested and transported as part of
                                a shipment.
                              </li>
                              <li>
                              ...
                              <li>
                                ...
                                functions within four hours of using alcohol.
                              </li>
                              <li>
                                No driver required to take a post-accident
                                alcohol test shall use alcohol for eight hours
                                following the accident, or until he or she
                              ...
                              <li>
                                ...
                                follow-up, alcohol or controlled substances
                                test.
                              </li>
                              <li>
                                No driver shall report for duty or remain on
                                duty when the driver uses any controlled
                                substance. An exception is when the use of the
                                controlled substance is pursuant to the
                                instructions of a physician who has advised the
                                driver that the substance does not adversely
                                affect the driver's ability to safely operate a
                                commercial motor vehicle. (The employer may
                            ...
                            concentration of 0.04 will result in a positive
                            test.
                            <br></br>
                            <ul>
                              <li>
                                ...
                                first time for an employer. (controlled
                                substances testing only).
                              </li>
                              <li>
                                Post-accident - administered as soon as
                                practicable, following an accident involving a
                                commercial motor vehicle, if there is a
                                fatality, or if the driver is cited for a moving
                                traffic violation. (we must test for alcohol
                                within 8 hours of the accident, and controlled
                                substances within 32 hours).
                              </li>
                              <li>
                                Random - administered if a driver's name is
                                selected in a random drawing, conducted
                                periodically throughout the year. Drivers
                                notified of a random selection must submit
                                immediately for testing.
                              </li>
                              <li>
                                Reasonable suspicion - administered if the
                                employer has reasonable suspicion to believe the
                                driver is in violation of any of the
                              ...
                              <li>
                                ...
                                also administer a return to duty test if a
                                driver is disqualified from the random pool for
                                any reason, and then re-enters the random pool.
                              </li>
                              <li>
                                Follow-up - If a driver has refused to test or
                                tested positive, and wishes to be re-qualified
                                to perform safety sensitive functions, he/she
                                must be counseled by a Substance Abuse
                                Professional (SAP), follow the recommended
                                program, and then produce a negative “Return to
                                Duty” test result. The SAP will then direct the
                                company to administer a minimum of six
                                “Follow-up” tests in the next 12 months. This
                                number may be increased by the SAP. The company
                                will select the times for the follow-up tests.
                              </li>
                            </ul>
                            <br></br>
                            <strong>Testing Procedures</strong>
                            <br></br>
                            All testing will be performed with procedures that
                            are outlined in the Code of Federal Regulations,
                            Part 40. These procedures are designed to protect
                            the driver, maintain integrity in the testing
                            process and safeguard the validity of the test
                            results.
                            <br></br>
                            ...
                            will be subject to termination from his/her
                            employment with{" "}
                            <strong style={style.textDriverName}>
                              {props.company.LegalName}
                            </strong>{" "}
                            ...
                            be required to submit to a Return to Duty controlled
                            substance and/or alcohol test.
                            <br></br>
                            <strong>Refusal to Test</strong>
                            <br></br>
                            If any driver refuses to test under the conditions
                            outlined in Part 382, the refusal will be treated as
                            a positive result, and will be subject to
                            consequences of a positive test.
                            <br></br>
                            <strong>Information</strong>
                            <br></br>
                            The following pages contain information regarding
                            the symptoms and effects of the use of alcohol and
                            controlled substances. All employees are encouraged
                            to be familiar with this document and with the
                            ...
                            stored in fat tissue cells, Loud, boisterous in
                            early stages Smoked or taken orally, Sleepy,
                            stuporous in later stages causes euphoria; increased
                            appetite; disoriented behavior; relaxed inhibitions;
                            negative effect on peripheral vision, Overdose can
                            ...
                            pupils Sniffed, smoked or injected, Dry mouth and
                            nose increased alertness; euphoria; excitation;
                            increased pulse and blood pressure; insomnia; loss
                            of appetite, Bad breath; frequent lip licking
                            Overdose can cause agitation; hallucination;
                            convulsions; possible death Lack of interest in food
                            and sleep.
                            <br></br>
                            <strong>Opiates</strong>
                            <br></br>
                            Drowsiness; lethargy Used as pain killer; cough
                            medicine, Slurred speech highly addictive (codeine
                            is moderately addictive), Constricted pupils Effect
                            lasts 3-6 hours, Needle scars Sniffed, injected,
                            smoked, taken orally, Loss of appetite Causes
                            euphoria; drowsiness; nausea, Nausea; flushed face
                            Overdose can cause slow, shallow breathing; clammy
                            skin; convulsions; possible death.
                            <br></br>
                            <strong>PCP</strong>
                            <br></br>
                            Increased heart rate/blood pressure No medical uses,
                            Flushing, sweating, dizziness, highly addictive;
                            effect lasts several numbness, drowsiness days,
                            Pupils dilated Smoked, injected, taken orally, Rigid
                            muscles, deadened actions Causes illusions;
                            hallucinations, Symptoms of intoxication Overdose
                            may cause more intense without smell of alcohol
                            trips; possible death.
                            <br></br>
                            <strong>
                              Physical Symptoms Uses and Effects Amphetamines.
                            </strong>
                            <br></br>
                            Increased heart and breathing Used for weight
                            control; to treat rates narcolepsy; attention
                            deficit disorder. High blood pressure; high fever
                            highly addictive, Dilated pupils Effect lasts 2-4
                            hours, Decreased appetite; dry mouth Injected or
                            taken orally, Sweating; headache; blurred Increased
                            alertness, pulse, and blood vision; dizziness
                            pressure; insomnia; loss of appetite; euphoria;
                            excitation, Unable to sleep Overdose may cause
                            agitation; convulsions; possible death.
                            <br></br>
                            <strong>Alcohol</strong>
                            <br></br>
                            ...
                            Withdrawn; may be violent; overly talkative,
                            Hangover (headaches), Smell of alcohol.
                          </div>
                        </div>
                      </Collapse>
                      {signatureAgreement(props.company.Id, props.driver.Id)}
            ...
            <ModalFooter>
              <a
                href={instance.url}
                download={`PDF Agreement - ${props.driver.Name} ${props.driver.LastName} .pdf`}
              >
...
export default DocumentAuthorizarion;
