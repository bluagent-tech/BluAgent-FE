...
class StateInspectionTrailer extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="col-md-3">
        <input
          ...
          src="assets/img/dashboard/back/maintenance/statet1.png"
          onMouseOver={e =>
            (e.currentTarget.src =
              "/assets/img/dashboard/front/maintenance/statet.png")
          }
          onMouseOut={e =>
            (e.currentTarget.src =
              "assets/img/dashboard/back/maintenance/statet1.png")
          }
          alt="Submit"
          height="100"
          width="100"
...
export default StateInspectionTrailer;
