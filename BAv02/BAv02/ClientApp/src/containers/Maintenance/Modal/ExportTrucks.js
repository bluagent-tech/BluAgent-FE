...
class ExportTrucks extends React.Component {
  constructor(props) {
    super(props);
        ...
        <ModalBody>
          <FormGroup row>
            <Col md="6">
              ...
              >
                <ExcelSheet data={this.props.dataExportTrucks} name="Trucks">
                  <ExcelColumn label="NUMBER #" value="index" />
                  <ExcelColumn label="VEHICLE #" value="VehicleNumber" />
                  <ExcelColumn label="VIN" value="Vin" />
                  <ExcelColumn label="LICENSE PLATE#" value="Plate" />
                  <ExcelColumn label="STATE" value="PlateState" />
                  <ExcelColumn label="REGISTRATION EXPIRATION DATE" value="PlateExp"/>
            ...
            <Col md="6">
              ...
              >
                <ExcelSheet
                  data={this.props.dataExportTrucksWithInspections}
                  name="Trucks with violations"
                >
                  <ExcelColumn label="NUMBER #" value="index" />
                  <ExcelColumn label="VEHICLE #" value="VehicleNumber" />
                  <ExcelColumn label="VIN" value="Vin" />
          ...
          <FormGroup row style={{ textAlign: "center" }}>
            <Col md="5">
              <h7>EXPORT ALL TRUCKS</h7>
            </Col>
            <Col md="7">
              <h7>EXPORT TRUCKS WITH ALL YOUR INSPECTIONS</h7>
            </Col>
          </FormGroup>
        </ModalBody>
      </Modal>
...
ExportTrucks.propTypes = {
  OnSubmit: PropTypes.func,
  toggle: PropTypes.func,
};

export default ExportTrucks;
