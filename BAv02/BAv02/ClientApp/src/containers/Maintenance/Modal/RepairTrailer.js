...
class RepairTrailer extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="col-md-3">
        <input
          ...
          src="assets/img/dashboard/back/maintenance/repair1.png"
          onMouseOver={(e) =>
            (e.currentTarget.src =
              "/assets/img/dashboard/front/maintenance/repair.png")
          }
          onMouseOut={(e) =>
            (e.currentTarget.src =
              "assets/img/dashboard/back/maintenance/repair.png")
          }
          alt="Submit"
          height="100"
          width="100"
        />
        <h6>Repair Trailer</h6>
