...
class StateInspection extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="col-md-3">
        <input
          ...
          src="assets/img/dashboard/back/maintenance/state1.png"
          onMouseOver={(e) =>
            (e.currentTarget.src =
              "/assets/img/dashboard/front/maintenance/state.png")
          }
          onMouseOut={(e) =>
            (e.currentTarget.src =
              "assets/img/dashboard/back/maintenance/state1.png")
          }
          alt="Submit"
          height="100"
          width="100"
