...
import MyMapBoxLabcorp from "./MyMapBoxLabcorp";
import MyMapBoxBluAgent from "./MyMapBoxBluAgent"
...
class DrugScheduleTest extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.selectedTestType = this.selectedTestType.bind(this);
    this.handleSubmit = this.handleSubmit.bind(this);
    this.showSchedule = this.showSchedule.bind(this);
    this.handleSearch = this.handleSearch.bind(this);
    // this.handleLocationsite=this.handleLocationsite(this);
  }
  ...
  componentDidMount() {
    if (User.Role === "COLLECTOR") {
      ...
      this.props.getScheduledTests(id);
    ...
    fetch(
      "api/DrugAndAlcoholTesting/GetCompanyDerName?companyId=" + this.props.idCompany || idCompany,
      {
        method: "GET",
      }
    )
  ...
  componentDidUpdate(prevProps) {
    ...
    else if (this.props.driversList !== prevProps.driversList) {
      this.props.getDriverListCollector(this.props.idCompany);
    }
  }
  ...
  mapScheduledsForDataTable(items, type) {
    ...
    let data = items.map((row) => {
      var object = {};
      object.photo = DriversImg(row.Image, row.IdDriver, this.props.idCompany || idCompany);
      type === "Drug"
    ...
    if (this.props.addCardModal === false) {
      ...
      if (status !== "Detail") {
        ...
        if (this.props.scheduleDyA.Performed !== "Alcohol") {
          idCompany === '174' ? form.append("amount", 4000) : form.append("amount", 6000);
  ...
  render() {
    ...
    const handelCollectionsite=(site)=>{
      this.setState({ collectionsite: site });
    }
                  ...
                  {this.state.Lab === "Labcorp" ||
                    ...
                    <>
                      <FormGroup row>
                        ...
                        <Col md="12">
                          <MyMapBoxLabcorp collectionsite={handelCollectionsite}/>
                        </Col>
                      </FormGroup>
                    </>
                            ...
                            <Row>
                              ...
                              <Col lg="4">
                                <img
                                  ...
                                  className="img-fluid"
                                  alt="BluAgent"
                                  src="assets/img/Images/bluagent.svg"
                                />
                              </Col>
                            </Row>
                          </CardBody>
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              {this.state.Lab === "Labcorp" ||
                ...
                <Row>
                  <Col lg="6">
                    <Card>
                      <CardHeader className="text-white"  style={{backgroundColor:'#5593d7'}}>TESTING LAB</CardHeader>
                      <CardBody>
                        <Row>
                          <Col lg="8">
                  ...
                  <Col lg="6">
                    <Card>
                      <CardHeader className="text-white"  style={{backgroundColor:'#5593d7'}}> MRO OFFICE</CardHeader>
                      <CardBody>
                        <Row>
                          <Col lg="8">
                            <label style={{ fontWeight: "bold" }}>
              ...
              <AddPayment typeTest={this.props.scheduleDyA.Performed} idCompany={idCompany} />
              <DataTable
                responsive={true}
                pagination
                columns={columns}
