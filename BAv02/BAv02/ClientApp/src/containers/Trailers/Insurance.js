...
class Insurance extends Component {
  ...
  handleSumit(e) {
    ...
    this.props.saveInsurance(insurance);
  }
          ...
          <Row>
            <Col md='4'>
              <FormGroup>
                ...
                <select
                  ...
                  value={
                    (this.props.trailer.InsuranceName !== null) &
                    (this.state.InsuranceName === '')
                      ? this.props.trailer.InsuranceName
                      : this.state.InsuranceName
                  }
                  required
                >
              ...
              <FormGroup>
                {this.state.InsuranceName === 'Other' ||
                (this.props.trailer.OtherInsurance !== null &&
                  this.state.InsuranceName === '') ? (
                  <Col id='other' md='4'>
                    <Label htmlFor='text-input'>Insurance Provider</Label>
                    <Input
                      type='text'
                      defaultValue={
                        this.props.trailer.InsuranceName === 'Other' &&
                        this.state.InsuranceName === ''
                          ? this.props.trailer.OtherInsurance
                          : ''
                      }
                      name='OtherInsurance'
                    />
                ...
                <DatePicker
                  ...
                  value={dateConvertTables(
                    this.props.trailer.InsuranceExpiration
                  )}
                />
              </FormGroup>
              <FormGroup>
                ...
                <select
                  ...
                  onChange={this.onChange}
                  value={
                    (this.props.trailer.OperationRadius !== null) &
                    (this.state.OperationRadius === '')
                      ? this.props.trailer.OperationRadius
                      : this.state.OperationRadius
                  }
                  required
                >
            ...
            <Col>
              <FormGroup>
                ...
                <select
                  ...
                  onChange={this.onChange}
                  value={
                    (this.props.trailer.PortEntry !== null) &
                    (this.state.PortEntry === '')
                      ? this.props.trailer.PortEntry
                      : this.state.PortEntry
                  }
                  required
                >
              ...
              <FormGroup>
                ...
                <select
                  ...
                  onChange={this.onChange}
                  value={
                    (this.props.trailer.PolicyTerm !== null) &
                    (this.state.PolicyTerm === '')
                      ? this.props.trailer.PolicyTerm
                      : this.state.PolicyTerm
                  }
                  required
                >
            ...
            <Col>
              <Button
                size='md'
                type='submit'
                className='text-white buttons-royal mt-4'
              >
                Save
              </Button>
