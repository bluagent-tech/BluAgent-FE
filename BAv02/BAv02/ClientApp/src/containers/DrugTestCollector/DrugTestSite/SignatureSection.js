    ...
    return (
      <React.Fragment>
        <Row className="d-flex justify-content-between container">
          <Signature
            signature={`https://bluagent-files.s3-us-west-2.amazonaws.com/Collectors/DrugTestSignatures/${this.props.specimenNumber}/CollectorSignature.png`}
          ...
          <Signature
            signature={`https://bluagent-files.s3-us-west-2.amazonaws.com/Collectors/DrugTestSignatures/${this.props.specimenNumber}/DonorSignature.png`}
        ...
        <Row>
          <Col sm="6">
            ...
            this.state.driverConfirmation ? (
              <Button type="submit" id="options" name="saveTest" color="success">
                Complete Collection
              </Button>
            ) : (
              ""
